...
public class Controller {
    @FXML
    private TextField YouTuberName;
    @FXML
    private Button Gene;
    @FXML
    ...
    public void Generation(){
        if (YouTuberName.getText().trim().isEmpty() && theObj.getText().trim().isEmpty() && theEvent.getText().trim().isEmpty() && EventSys.getText().trim().isEmpty()){
            theArticle = "　　大家好，欢迎来到本期小编看世界。辣椒有的人不爱吃是怎么回事呢？辣椒相信大家都很熟悉，但是辣椒有的人不爱吃是怎么回事呢，下面就让小编带大家一起了解吧。\n" +
                    "　　辣椒有的人不爱吃，其实就是辣椒太辣了，有些人讨厌吃辣，大家可能会很惊讶辣椒怎么会有的人不爱吃呢？但事实就是这样，小编也感到非常惊讶。\n" +
                    "　　这就是关于辣椒有的人不爱吃的事情了，大家有什么想法呢，欢迎在评论区告诉小编一起讨论哦！";
        } else if (YouTuberName.getText().trim().isEmpty() || theObj.getText().trim().isEmpty() || theEvent.getText().trim().isEmpty() || EventSys.getText().trim().isEmpty()){
            ...
            String str3 = YouTuberName.getText();
            theArticle = "    大家好，欢迎来到本期" + str3 + "。" + str0 + str1 + "是怎么回事呢？" + str0 + "相信大家都很熟悉，但是" + str0 + str1 + "是怎么回事呢，下面就让小编带大家一起了解吧。\n"+
